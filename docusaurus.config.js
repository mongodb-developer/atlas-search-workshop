...
const workshopName = 'atlas-search-workshop';
// Change this if hosting outside mongodb-developer
const organizationName = "mongodb-developer";

// Main page config
const title = "Atlas Search Workshop";
const tagLine = "An Atlas Search Workshop";
const startButtonTitle = "Let's Search";
...
const utmWorkshopName = 'atlas_search_workshop'
